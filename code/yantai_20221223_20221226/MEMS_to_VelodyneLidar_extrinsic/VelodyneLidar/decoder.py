...
class VelodyneDecoder(object):
    ...
    def decode_next_packet(self):
        ...
        try:
            ...
            if len(pkg) == 1248:
                ...
                is_delay_packet, time_offset = self.isdelay_datapacket()
                if is_delay_packet:
                    # delay happened
                ...
                is_delay_packet, time_offset = self.isdelay_positionpacket()
    ...
    def isdelay_positionpacket(self):
        is_delay_packet = False
    ...
    def cal_pts_in_packet(self):
        ...
        # use get unix timestamp
        self.pts_packet['unix_timestamp'] = self.data_packet.timestamp_packet_receive
