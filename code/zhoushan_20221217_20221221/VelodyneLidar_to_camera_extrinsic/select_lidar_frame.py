...
def main():
    data_path = 'F:\\sensors_calibration_v2\\rawdata\\20221217_calibration\\cameras_lidar_calibration\\VelodyneLidar\\camera_lidar_calib_20221217.pcap'
    camera_timestamps_path = './camera_timestamps1.txt'
    lidar_timestamps_path = './lidar_timestamps1.txt'

    # data_path = 'F:\\sensors_calibration_v2\\rawdata\\20221221_calibration\\cameras_lidar_calibration\\VelodyneLidar\\calib_20221221_1513.pcap'
    # camera_timestamps_path = './camera_timestamps2.txt'
    # lidar_timestamps_path = './lidar_timestamps2.txt'
    ...
    while 1:
        ...
        if vd.judge_jump_cut_degree():
            ...
            if generate_flags.sum() == len(generate_flags):
